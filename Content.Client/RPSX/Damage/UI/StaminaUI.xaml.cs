...
public sealed partial class StaminaUI : UIWidget
{
    ...
    public StaminaUI()
    {
        ...
        {
            Texture = _resourceCache.GetResource<TextureResource>("/Textures/RPSX/Interface/stamina/stamina_bar.png"),
            TextureScale = new Vector2(_scale, _scale),
            Mode = StyleBoxTexture.StretchMode.Tile
        };
        ChargeBar.ForegroundStyleBoxOverride = new StyleBoxTexture()
        {
            Texture = _resourceCache.GetResource<TextureResource>("/Textures/RPSX/Interface/stamina/stamina_bar_value.png"),
            TextureScale = new Vector2(_scale, _scale),
            Mode = StyleBoxTexture.StretchMode.Tile
        };
    }
