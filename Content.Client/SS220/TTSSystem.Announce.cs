...
public sealed partial class TTSSystem : EntitySystem
{
    ...
    {
        _cfg.OnValueChanged(TTSVars.TTSAnnounceVolume, OnTtsAnnounceVolumeChanged, true);
        SubscribeNetworkEvent<AnnounceTTSEvent>(OnAnnounceTTSPlay);
    }

    private void ShutdownAnnounces()
    {
        _cfg.UnsubValueChanged(TTSVars.TTSAnnounceVolume, OnTtsAnnounceVolumeChanged);
    }
