...
public sealed class TTSManager
{
    ...
    public void Initialize()
    {
        ...
        _cfg.OnValueChanged(TTSVars.TTSMaxCache, val =>
        {
            _maxCachedCount = val;
            ResetCache();
        }, true);
        _cfg.OnValueChanged(TTSVars.TTSRequestTimeout, val => _timeout = val, true);
        _cfg.OnValueChanged(TTSVars.TTSApiUrl, v => _apiUrl = v, true);
        _cfg.OnValueChanged(TTSVars.TTSApiToken, v =>
            {
