...
cco-console-crew-member-penalties = Сумма штрафов:
cco-console-crew-member-bonuses = Сумма премий:
cco-console-crew-member-input-placeholder = Введите целое число
cco-console-crew-member-bonus-button = Выписать премию
cco-console-crew-member-penalty-button = Выписать штраф
