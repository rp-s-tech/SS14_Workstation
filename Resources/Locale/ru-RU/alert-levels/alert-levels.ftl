...
alert-level-crimson-announcement = Центральное командование объявляет на станции уровень угрозы "Багровый".
...
alert-level-crimson-instructions = При любом сопротивлении разрешено применение летального оружия и полная нейтрализация отдела. Остальной персонал должен быть готов к эвакуации.
...
alert-level-brown-announcement = Центральное командование объявляет на станции уровень угрозы "Коричневый".
...
alert-level-brown-instructions = Все члены командования должны немедленно отчитаться перед представителями NanoTrasen, которые временно возьмут на себя управление станцией.
