...
ent-CrateServiceHolidayLights = ящик гирлянд
    .desc = Украсьте залы этими праздничными гирляндами!
...
ent-CrateServiceColorfulLights = ящик с разноцветными огнями
    .desc = Это не вечеринка, если на ней ты не нвчинаешь плохо видеть, немного дезориентируешся, и у тебя не болят уши.
