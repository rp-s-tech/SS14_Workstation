...
ent-ClothingHandsKnuckleDustersQM = золотые кастеты квартирмейстера
    .desc = Кастеты из 24-каратного золота с пласталевым покрытием и логотипом НаноТрейзен. Истинный символ власти квартирмейстера.
...
ent-ClothingHandsKnuckleDustersStun = шоковые кастеты
    .desc = Гибрид кастетов и электрошокера. Идеальны для усмирения буйных нарушителей.
