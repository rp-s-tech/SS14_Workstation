...
ent-ClothingUniformJumpskirtCommandGeneric = Спортивная юбка командования
    .desc = Обычный комбинезон командирского цвета, не связанный с каким-либо конкретным подразделением.
