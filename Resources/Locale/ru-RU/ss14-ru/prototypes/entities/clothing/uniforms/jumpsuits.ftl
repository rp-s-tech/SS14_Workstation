...
ent-ClothingUniformJumpsuitCommandGeneric = комбенизон командования
    .desc = Обычный комбинезон цвета командования, не связанный с каким-либо конкретным подразделением.
