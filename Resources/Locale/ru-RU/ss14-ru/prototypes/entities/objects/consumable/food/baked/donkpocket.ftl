...
ent-FoodDonkpocketMoth = моль-пакет
    .desc = Популярная версия donk-pocket, которая была создана во время массовых протестов в... а кого это волнует? Просто берите молиные donk-pocket.
