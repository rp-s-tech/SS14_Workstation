...
ent-FoodBoxDonkpocketMoth = коробка моль-пакетов
    .desc = { ent-FoodBoxDonkpocket.desc }
...
ent-FoodMealHappyHonkBigBite = Большой кусок Happy Honk
    .desc = Кто-то заплатил хорошие деньги за доставку этого блюда из фаст-фуда только по этому, оно пахнет свежестью.
