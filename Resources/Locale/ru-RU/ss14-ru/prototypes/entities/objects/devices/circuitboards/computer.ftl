...
ent-CargoRequestEngineeringComputerCircuitboard = инженерная плата запросов
    .desc = Компьютерная печатная плата для компьютера с инженерными запросами.
ent-CargoRequestMedicalComputerCircuitboard = медицинская плата запросов
    .desc = Компьютерная печатная плата для компьютера с медицинскими запросами.
ent-CargoRequestScienceComputerCircuitboard = научная плата запросов
    .desc = Компьютерная печатная плата для компьютера science request.
ent-CargoRequestSecurityComputerCircuitboard = СБ плата запросов
    .desc = Компьютерная печатная плата для компьютера с запросом безопасности.
ent-CargoRequestServiceComputerCircuitboard = сервисная
    .desc = Компьютерная печатная плата для компьютера с запросом на обслуживание.
ent-FundingAllocationComputerCircuitboard = компьютерная плата распределения финансирования
    .desc = Компьютерная печатная плата для консоли распределения финансовых средств.
...
ent-WizardCommsComputerCircuitboard = консоль связи Магов (консольная плата)
    .desc = Консольная плата для консоли связи Магов.
