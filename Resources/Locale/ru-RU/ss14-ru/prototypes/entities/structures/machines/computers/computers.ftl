...
ent-ComputerCargoOrdersEngineering = инженерный терминал заказов
    .desc = Используется инженерным отделом для заказа материалов.
ent-ComputerCargoOrdersMedical = медицинский терминал заказов
    .desc = Используется медицинским отделом для заказа материалов.
ent-ComputerCargoOrdersScience = научный терминал заказов
    .desc = Используется научным отделом для заказа материалов.
ent-ComputerCargoOrdersSecurity = терминал заказов СБ
.desc = Используется службой безопасности для заказа материалов.
ent-ComputerCargoOrdersService = сервисный терминал заказов
