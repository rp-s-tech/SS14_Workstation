...
uplink-estoc-bundle-desc = Специальная снайперская винтовка, оснащенная оптикой средней дальности для ведения огня на дальние дистанции. В комплекте два магазина.(.20 винтовочные).
